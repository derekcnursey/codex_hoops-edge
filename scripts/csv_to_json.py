#!/usr/bin/env python3
"""Convert prediction CSV to site-compatible JSON.

Usage: csv_to_json.py /path/to/preds.csv [YYYY-MM-DD]

Output directories: predictions/json/ and site/public/data/
"""
import csv
import json
import os
...
FIELD_MAP = {
    "away_team": ["away_team_name", "away_team", "awayTeam"],
...
def main() -> int:
    ...
    if not date_value:
        # Try extracting from startDate column
        date_value = extract_date(rows[0].get("startDate", ""))
